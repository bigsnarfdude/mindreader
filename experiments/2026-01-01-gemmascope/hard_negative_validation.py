...
def main():
    ...
    print(sep)
    print("HARD NEGATIVE VALIDATION - 27B V2")
    print(sep)

    # Load V2 model
    print("\nLoading 27B V2 model...")
    base_model = AutoModelForCausalLM.from_pretrained(
        "unsloth/gemma-3-27b-it",
        torch_dtype=torch.bfloat16,
        device_map="auto",
    )
    model = PeftModel.from_pretrained(base_model, "vincentoh/gemma3-27b-af-detector-v2")
    model.eval()
    ...
    # Save results
    results = {
        "model": "vincentoh/gemma3-27b-af-detector-v2",
        "layer": layer,
    ...
    with open("hard_negative_validation_27b_v2.json", "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nSaved to hard_negative_validation_27b_v2.json")
    ...
    print(sep)
    print(f"""
### Hard Negative Validation (27B v2, Layer 40)
